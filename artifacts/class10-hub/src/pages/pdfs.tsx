      ...
      <div className="py-8 md:py-12">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Official previous year question papers (2022–2025) sourced directly from the CBSE website. Click any card to download from the official source.
          </p>

          {/* Official badge */}
          <div className="mt-5 inline-flex items-center gap-2 px-4 py-2 rounded-full border border-green-300 dark:border-green-700 bg-green-50 dark:bg-green-950/30 text-green-700 dark:text-green-400 text-sm font-medium">
            <ShieldCheck size={16} />
          ...
          {filteredPdfs.length === 0 ? (
            ...
            filteredPdfs.map((pdf, idx) => (
              ...
              >
                ...
                <h3 className="text-lg font-display font-bold mb-3 line-clamp-2 leading-snug" title={pdf.title}>
                  {pdf.title}
                </h3>
